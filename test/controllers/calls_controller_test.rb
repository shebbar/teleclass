...
class CallsControllerTest < ActionController::TestCase
  ...
  test "should create call" do
    assert_difference('Call.count') do
      post :create, call: { call_date: @call.call_date, call_time: @call.call_time, duration: @call.duration }
    end
  ...
  test "should update call" do
    patch :update, id: @call, call: { call_date: @call.call_date, call_time: @call.call_time, duration: @call.duration }
    assert_redirected_to call_path(assigns(:call))
  end
